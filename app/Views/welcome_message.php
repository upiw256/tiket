...
<div class="overflow-x-auto relative shadow-md sm:rounded-lg m-4">
		...
		<a href="#" class="text-center"><div class="bg-gray-600 pb-10 text-white font-bold pt-10">+ TAMBAH DATA +</div></a>
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 mt-10">
        ...
        <tbody>
            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                ...
                <td class="py-4 px-6">
                    <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit </a>|<a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline"> Hapus</a>
                </td>
            </tr>
